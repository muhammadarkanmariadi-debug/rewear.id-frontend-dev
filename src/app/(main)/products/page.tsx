          ...
          {products.length > 0 && (
            <div className="mt-12 flex justify-center">
              <div className="flex items-center gap-1 shadow-sm rounded-lg border border-border p-1 bg-surface-container-low">
                ...
                <button className="w-8 h-8 flex items-center justify-center text-sm font-medium hover:bg-background transition-colors rounded-md">2</button>
                <button className="w-8 h-8 flex items-center justify-center text-sm font-medium hover:bg-background transition-colors rounded-md">3</button>
